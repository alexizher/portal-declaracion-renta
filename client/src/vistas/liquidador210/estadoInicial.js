...
export function crearEstadoInicial(anioGravable = 2025) {
  return {
    ...
    honorarios: {
      ...
      incrngo: enCeros(CONCEPTOS_INCRNGO_HONORARIOS),
      rentasExentasLimitadas: enCeros(CONCEPTOS_RENTAS_EXENTAS_LIMITADAS_HONORARIOS),
      rentasExentasNoLimitadas: enCeros(CONCEPTOS_RENTAS_EXENTAS_NO_LIMITADAS_HONORARIOS),
      costosYGastos: 0,
      afcPensionVoluntaria: 0,
      medicinaDigitado: 0,
      viviendaDigitado: 0,
    ...
    noLaboral: {
      ...
      incrngo: enCeros(CONCEPTOS_INCRNGO_NO_LABORAL),
      rentasExentasLimitadas: enCeros(CONCEPTOS_RENTAS_EXENTAS_LIMITADAS_NO_LABORAL),
      rentasExentasNoLimitadas: enCeros(CONCEPTOS_RENTAS_EXENTAS_NO_LIMITADAS_NO_LABORAL),
